...
public class ReportSavedFormListAdapter extends BaseQuickAdapter<ReportDetailsEntity, BaseViewHolder> {

    public ReportSavedFormListAdapter(int layoutResId, @Nullable List<ReportDetailsEntity> data) {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        EventBus.getDefault().post(new ReportSavedFormListItemEvent.ReportSavedFormListItemClick(item));
                    }
                }, 100);
