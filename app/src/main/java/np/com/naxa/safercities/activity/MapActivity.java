...
import np.com.naxa.safercities.osm_convertor.multipolygon.Feature;
import np.com.naxa.safercities.osm_convertor.multipolygon.FeatureCollection;
import np.com.naxa.safercities.osm_convertor.multipolygon.Properties;
import np.com.naxa.safercities.osm_convertor.polygon.Properties_;
            ...
            switch (type) {
                case "MultiPolygon":
                    for (int i = 0; i < feature.getGeometry().getCoordinates().size(); i++) {
                        np.com.naxa.safercities.osm_convertor.polygon.Feature feature1 = new np.com.naxa.safercities.osm_convertor.polygon.Feature();

                        np.com.naxa.safercities.osm_convertor.polygon.Geometry geometry = new np.com.naxa.safercities.osm_convertor.polygon.Geometry();
                        ...
                        List<np.com.naxa.safercities.osm_convertor.polygon.Feature> featureList = new ArrayList<>();
                        featureList.add(feature1);


                        np.com.naxa.safercities.osm_convertor.polygon.FeatureCollection featureCollection1 = new np.com.naxa.safercities.osm_convertor.polygon.FeatureCollection();
